const questions = {
    week1: [
        {
            ...
            options: ["pull factor", "push factor", "demographic factor", "Chemical"],
            answer: 1
        },
        {
        ...
        },
        {
            ...
            options: ["to keep", "together", "house", "manage"],
            answer: 1
        },
        {
        ...
        },
        {
            ...
            options: ["pull factor", "push factor", "chemical factor", "demographic factor"],
            answer: 0
        },
        {
        ...
        },
        {
            ...
            options: ["Population Geography", "Phytogeography", "Economic Geography", "Zoogeography"],
            answer: 0
        },
        {
            question: "\"Allowing some places and some creatures to exist without significant human interference\" is the definition of:",
            options: ["conservation", "environmentalism", "preservation", "ecology"],
            answer: 2
        },
        {
            question: "The movement of lions across the Gir landscape is an example of:",
            options: ["secular dispersal", "diffusion", "jump dispersal", "drifting"],
            answer: 1
        }
    ],
    week2: [
        {
            ...
            options: ["these are longitudinal waves", "these are transverse in nature", "they cannot move through gases", "they cannot move through liquids"],
            answer: 0
        },
        {
        ...
        {
            question: "Which of these is an example of direct source of information about Earth?",
        ...
        {
            question: "Within a depositional basin, strata are laterally continuous in all directions till the edge basin. This is known as:",
            options: ["principle of superposition", "principle of original horizontality", "principle of lateral continuity", "principle of inclusions"],
            answer: 2
        },
        {
    ...
    week3: [
        {
            ...
            options: ["cleavage", "structure", "lustre", "streak"],
            answer: 2
        },
        {
            question: "'Ease of passage of light through mineral' is known as:",
            options: ["transparency", "fracture", "structure", "streak"],
            answer: 0
        },
        {
        ...
        {
            question: "'Green or black-colored inosilicates forming 10% of the Earth's crust' is a description of:",
            options: ["amphiboles", "quartz", "feldspar", "pyroxene"],
            answer: 3
        },
        {
            question: "'The ridge edge where two cirques meet' is the definition of:",
            options: ["glacier", "arete", "horn", "hanging valley"],
            answer: 1
        },
        {
        ...
        },
        {
            ...
            options: ["smooth grained sedimentary rocks", "coarse grained sedimentary rocks", "smooth grained igneous rocks", "coarse grained igneous rocks"],
            answer: 2
        },
        {
    ...
    week4: [
        ...
        },
        {
            ...
            options: ["it is maximum at pole and zero at equator", "it is zero at poles and maximum at equator", "in the Northern hemisphere, it deflects winds towards left", "in the Southern hemisphere, it deflects winds towards right"],
            answer: 0
        },
        {
            question: "From the surface of the Earth to upwards, which of these is the correct sequence of atmospheric layers?",
            options: ["troposphere, stratosphere, mesosphere, thermosphere, exosphere", "troposphere, mesosphere, stratosphere, thermosphere, exosphere", "troposphere, thermosphere, mesosphere, stratosphere, exosphere", "troposphere, exosphere, thermosphere, mesosphere, stratosphere"],
            answer: 0
        },
        {
    ...
    week5: [
        ...
        },
        {
            ...
            options: ["phase separation", "gravity", "coriolis force", "arrangement of coasts"],
            answer: 3
        },
        {
    ...
    week6: [
        ...
        },
        {
            ...
            options: ["the Deccan plateau", "the central highlands", "the north-eastern plateau", "all of these"],
            answer: 3
        },
        {
    ...
    week7: [
        ...
        },
        {
            ...
            options: ["rock --> crustose lichen --> foliose lichen --> moss --> herbaceous stage --> shrub --> woodland --> climax",
    ...
    week8: [
        ...
        {
            question: "The elephant has a home range of several square kilometers, regulates the ecosystem by its habit of destructive feeding, and people can relate to this animal which is important for conservation. Given this background, the elephant can be called as",
    ...
    week9: [
        ...
        {
            question: "Which of these is commonly observed during the humanising of nature?",
            options: ["environmental determinism", "possibilism", "neodeterminism", "stop and go determinism"],
            answer: 1
        },
        {
    ...
    week10: [
        {
            ...
            options: ["electricity generation", "mobile sources", "industrial processes", "residential fuel"],
            answer: 0
        },
        {
        ...
        },
        {
            ...
            options: ["animal manure", "mineral fertilizer", "crops and their deposition", "human waste"],
            answer: 0
        },
        {
    ...
    week11: [
        ...
        },
        {
            ...
            options: ["traffic intensity", "speed of vehicles", "driver sensitivity", "all of the above"],
            answer: 3
        },
        {
        ...
        },
        {
            ...
            options: ["bridge underpass", "box culverts", "pipe culverts", "all of these"],
            answer: 3
        },
        {
...
// Define combined weeks for questions
const combinedWeeks = {
    week1to12: [
        {
            question: "Scarcity of food is a:",
...
// Function to start the quiz for the selected week
function startQuiz(week) {
    currentQuestions = combinedWeeks[week] ? shuffleArray(combinedWeeks[week]) : shuffleArray(questions[week]);
...
// Function to randomly select 50 questions from the selected week or range of weeks
function startRandomQuiz(week) {
    // Get all the questions for the selected week or range from combinedWeeks or questions object
    const totalQuestions = combinedWeeks[week] || questions[week];

    // Ensure there are at least 50 questions to choose from
    if (totalQuestions.length < 50) {
        alert("There are not enough questions to select 50.");
        return;
    }

    // Shuffle the array and select the first 50 questions
    const random50Questions = shuffleArray(totalQuestions).slice(0, 50);
    currentQuestions = random50Questions;
    currentQuestionIndex = 0;
    score = 0;
    incorrectAnswers = [];

    // Start the quiz with 50 random questions
    document.getElementById("quizContainer").classList.remove("hidden");
    document.getElementById("resultContainer").classList.add("hidden");
    showQuestion();
}

// Utility function to shuffle the array (questions/options)
    ...
    if (selectedOption) {
        ...
        if (answerIndex === currentQuestion.answer) {
            ...
            incorrectAnswers.push({
                ...
                selectedAnswer: currentQuestion.options[answerIndex], // Store the selected answer
                correctAnswer: currentQuestion.options[currentQuestion.answer],
                options: currentQuestion.options // Store options for display
            });
        }
...
function showResult() {
    ...
    const incorrectQuestionsList = document.getElementById("incorrectQuestions");
        ...
        li.innerHTML = `<strong>${item.question}</strong><br>
                        <ul>
                          ${item.options.map((option, optionIndex) => {
                              const isCorrect = optionIndex === currentQuestions[currentQuestions.findIndex(q => q.question === item.question)].answer;
                              const isSelected = item.selectedAnswer === option;
                              let style = "";

                              if (isSelected && !isCorrect) {
                                  style = 'color: red;'; // Selected answer is incorrect
                              } else if (isCorrect) {
